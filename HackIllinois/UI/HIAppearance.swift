...
struct HIAppearance: Equatable {
    ...
    // TODO: Remove the colors that aren't needed
    // Hack 2021 color palette
    ...
    // TODO: Remove older colors below
    ...
    enum Font {
        ...
        static let loginSelection = UIFont.systemFont(ofSize: 16, weight: .regular)
