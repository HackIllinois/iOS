...
extension UIImage {
    ...
    convenience init?(qrString: String, color: UIColor, backgroundImage: UIImage, logo: UIImage) {
        ...
        let simpleQRCode = maskToAlphaFilter.outputImage
        ...
        guard let backgroundCGImage = backgroundImage.cgImage,
              ...
              let tintedQRCode = invertedQRCode.tinted(using: color),
